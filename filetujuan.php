...
//echo "<br/>";
//echo "First Name: ".$hasil['first_Name']."<br/>";
//echo "Last Name: ".$hasil['last_Name']."<br/>";
...
if($action == 'create')
{
	$sql= "INSERT INTO `tbl_user` VALUES ('$hasil[first_name]','$hasil[last_name]','$hasil[user_name]','$hasil[email]','$hasil[address]','$hasil[address2]','$hasil[ccname]','$hasil[ccnumber]','$hasil[ccexpire]','$hasil[cvv]','{$namafilebaru}')";
}
elseif ($action == 'update')
{
	$sql = "UPDATE tbl_user SET first_name =  '$hasil[first_name]', lastName = '$hasil[lastname]',foto = '$namafilebaru' where first_name = '$hasil[first_name]'";
}
elseif($action == 'delete')
{
	$sql = "DELETE from tbl_user where first_name = '$hasil[first_name]'";
}
elseif($action == 'read')
{
